            ...
            ">
                                ...
                                <ul class="flex flex-wrap items-center">
                                    <li class="sm:mr-5 xl:mr-[20px] relative group"><a href="#">
                                            <img src="assets/images/user/logosmall.png" loading="lazy" width="62" height="62" alt="avater">
                                        </a>
                ...
                ">
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="#" class="font-recoleta leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-primary hover:text-white text-center my-[-1px] rounded-t-[12px]">login</a>
                                            </li>

                                        </ul>
                                    </li>
                                    <li>
                                        <a href="/form-pendaftaran-tahfidz" class="before:rounded-md before:block before:absolute before:left-auto before:right-0 before:inset-y-0 before:-z-[1] before:bg-secondary before:w-0 hover:before:w-full hover:before:left-0 hover:before:right-auto before:transition-all leading-none px-[20px] py-[15px] capitalize font-medium text-white hidden sm:block text-[14px] xl:text-[16px] relative after:block after:absolute after:inset-0 after:-z-[2] after:bg-primary after:rounded-md after:transition-all">
                                            Daftar Sekarang
                                        </a>
                                    </li>
            ...
            <div class="py-12 pr-5 h-[100vh] overflow-y-auto">
                ...
                <nav class="offcanvas-menu">
                    <ul>
                        ...
                        {{-- <li class="relative block border-b-primary border-b"><a href="#" class="relative block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5">Informasi</a>

                            <ul class="offcanvas-submenu static top-auto hidden w-full visible opacity-100 capitalize">
                                <li>
                                    <a href="#" class="text-sm pt-3 px-10 pb-1 text-black font-light block transition-all hover:text-secondary">agency</a>
                                </li>
                            </ul>
                        ...
                        <li class="relative block border-b-primary border-b"><a href="/sekretariat" class="relative block capitalize text-black hover:text-secondary text-base my-2 py-1 px-5">Kontak</a></li>
                        <li class="relative block border-b-primary border-b"><a href="/" class="relative block capitalize text-black hover:text-secondary text-base my-2 py-1 px-5">Brosur</a></li>
                        <li class="relative block border-b-primary border-b"><a href="/form-pendaftaran-tahfidz" class="relative block capitalize text-black hover:text-secondary text-base my-2 py-1 px-5">Form Pendaftaran</a></li>
                    </ul>
                </nav>
                <!-- offcanvas-menu end -->
